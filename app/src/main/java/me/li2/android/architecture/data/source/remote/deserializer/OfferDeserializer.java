...
public class OfferDeserializer implements JsonDeserializer {
    ...
    public Offer deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        // notebyweiyi: Data Deserialization of Object which is part of JsonObject
        PricePackage lowestPricePackage = new PricePackageConverter().fromString(jsonObject.get("lowestPricePackage").getAsJsonObject().toString());

        // notebyweiyi: Data Deserialization of Arrays/Lists which is part of JsonObject
        List<BannerImage> images = new BannerImageListConverter().fromString(jsonObject.get("images").getAsJsonArray().toString());
